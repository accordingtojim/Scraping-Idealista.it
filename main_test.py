...
from test_playwright import fetch_html_from_links
...
download_html_folder = "download"
os.makedirs(download_html_folder, exist_ok=True)
...
if 0:
    fetch_html_from_links(links,download_html_folder)
